...
CHANNEL_LIST = {
    'J': {
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=0958b9c657622c465a6205eb2252b8ed&key=2d2fd7b1661b1e28de38268872b48480'
    },
    'JUHD': {
        'name': '翡翠台 4K',
        'license': '2c045f5adb26d391cc41cd01f00416fa:fc146771a9b096fc4cb57ffe769861be',
        'logo': 'https://gitjs.tianshideyou.eu.org/https://raw.githubusercontent.com/wanglindl/TVlogo/main/img/TVB1.png',
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=2c045f5adb26d391cc41cd01f00416fa&key=fc146771a9b096fc4cb57ffe769861be'
    },
    'B': {
        'name': 'TVBplus',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=56603b65fa1d7383b6ef0e73b9ae69fa&key=5d9d8e957d2e45d8189a56fe8665aaaa'
    },
    'P': {
        'name': '明珠台',
        'license': 'e04facdd91354deee318c674993b74c1:8f97a629de680af93a652c3102b65898',
        'logo': 'https://gitjs.tianshideyou.eu.org/https://raw.githubusercontent.com/wanglindl/TVlogo/main/img/TVB1.png',
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=e04facdd91354deee318c674993b74c1&key=8f97a629de680af93a652c3102b65898'
    },
    'CWIN': {
        'name': 'Super Free',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=0737b75ee8906c00bb7bb8f666da72a0&key=15f515458cdb5107452f943a111cbe89'
    },
    'TVG': {
        'name': '黄金翡翠台',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=8fe3db1a24969694ae3447f26473eb9f&key=5cce95833568b9e322f17c61387b306f'
    },
    'C': {
        'name': '无线新闻台',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=90a0bd01d9f6cbb39839cd9b68fc26bc&key=51546d1f2af0547f0e961995b60a32a1'
    },
    'CTVE': {
        'name': '娱乐新闻台',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=6fa0e47750b5e2fb6adf9b9a0ac431a3&key=a256220e6c2beaa82f4ca5fba4ec1f95'
    },
    'PCC': {
        'name': '凤凰卫视中文台',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=7bca0771ba9205edb5d467ce2fdf0162&key=eb19c7e3cea34dc90645e33f983b15ab'
    },
    'PIN': {
        'name': '凤凰卫视资讯台',
        ...
        'license_key': 'https://ott.tianshideyou.eu.org/api/results.php?keyid=83f7d313adfc0a5b978b9efa0421ce25&key=ecdc8065a46287bfb58e9f765e4eec2b'
    },
    'PHK': {
        'name': '凤凰卫视香港台',
...
def get_mytvsuper(channel):
    ...
    api_token = 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..sfmznKxlpsbiWmNmAOiCTkXsJ47l4yM73TAOCwNjYJzlIJAiM1i9F6CsJ71QKLJ-ovNqpW2U5mrBRhcaeDNzLsJZ_Hyg9Rc5vnXWHr6zexvzQ7BEYgvINrFtXLoUSSoOWBjKoqIezSBJ4ns2xVY_hm5_p_pgiRy7nbclnGiYXrhrTvtO3YOIXoutjMWpdRMvQFAr5ZKgkzqCTYvp5bbpKVx3LndoGEuAcXT0vwWeUpAedrcdEWVdJJV8OAXOxop2VYaqJ0caZDguPsHfA8rWaZtzbRLEDanNpctOCiSLNkAXlyeu4vlw6M54IdrSH1pLDyzqGcgfGETMZ6pQjCBMpJhy6W3nsJoIeW0LvWyWPdhpSYo6euh_aqUm_jpeT7T1HjA0l_maXUhk_Z0xD5FxVi8lKejNp6TTesgtcGI6Zied7iglKXYR4CLxY3aQhsoFlXmsUMaPITZ-idP89jV6dh-DB84WZYioaxmVB6dmvsKsfpuBJ5Z19qenlPHlZPE_M79H_nOTXn1EUJgXYCFS_kFf2XE-vRWk7c8nblHLpLQgkcLCuxWol13OlMifv3T6CG39S067MTyhIq3r8twp6M-k3sjOAfvwxrbKy5JiJYrCjIbBFnv1Csaa7rpWs3AR2Eu9M2XUwFg7JVKCVgvGfQUt19XjgC80HDMxv4d7wfE'  # 请自行获取
    headers = {
...
with open('mytvfree.m3u', 'w', encoding='utf-8') as m3u_file:
   ...
   # 或者替换为 m3u_file.write("#EXTM3U url-tvg=\"http://cfpgwztz.wofuck.rr.nu/https://xmltv.bph.workers.dev\"\n")
    m3u_file.write("#EXTM3U url-tvg=\"https://wztz.wokaotianshi.eu.org/wztz/http/xmltv.bph.workers.dev\"\n")
